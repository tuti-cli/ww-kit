...
**Read `.ww-kit/skill-context/wws-docs/SKILL.md`** — MANDATORY if the file exists.
...
Use `Glob` to find all `*.md` files in the project root (exclude `node_modules/`, `.ww-kit/`, agent dirs):
...
7. **Ownership boundary** — this command owns documentation artifacts (`README.md`, `docs/*`, and the Documentation section in `AGENTS.md`), not `.ww-kit/ROADMAP.md`, `.ww-kit/RULES.md`, or `.ww-kit/RESEARCH.md`
