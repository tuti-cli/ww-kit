...
**Read `.ww-kit/skill-context/wws-ci/SKILL.md`** — MANDATORY if the file exists.
...
Suggest: `/wws-build` for CI targets in Makefile/Taskfile, `/wws-docker` for containerization.
