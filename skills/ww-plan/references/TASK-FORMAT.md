...
- Docs: yes/no  # yes => mandatory docs checkpoint in /ww-do, no/unset => WARN [docs] only

## Roadmap Linkage (optional)
<!-- Only when .ww-kit/ROADMAP.md exists -->
Milestone: "[milestone name from ROADMAP.md]"  # or "none"
Rationale: [1 short sentence]

## Research Context (optional)
<!-- If .ww-kit/RESEARCH.md exists, copy/paste the Active Summary here -->
