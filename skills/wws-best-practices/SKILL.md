...
**Context:** If `.ww-kit/ARCHITECTURE.md` exists, follow its folder structure, dependency rules, and module boundaries alongside these guidelines.

**Read `.ww-kit/skill-context/wws-best-practices/SKILL.md`** — MANDATORY if the file exists.
...
- `/wws-best-practices` — Full overview
- `/wws-best-practices naming` — Naming conventions
- `/wws-best-practices structure` — Code organization
- `/wws-best-practices errors` — Error handling
- `/wws-best-practices testing` — Testing practices
- `/wws-best-practices review` — Code review checklist
...
- [ ] **Security**: Any vulnerabilities? (see `/wws-security`)
