...
Practical examples of `/ww-reference` usage and expected output.
...
**Result:** `.ww-kit/references/zod-validation.md`
...
**Result:** `.ww-kit/references/astro-framework.md`
...
**Result:** `.ww-kit/references/internal-api.md`
