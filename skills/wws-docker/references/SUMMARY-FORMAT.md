...
Options:
1. Build automation — Run /wws-build to add Docker targets to Makefile/Taskfile
2. Update docs — Run /wws-docs to document the Docker setup
3. Both — Build automation first, then docs
4. Done — Skip follow-ups
```

**If build automation** → suggest invoking `/wws-build`
**If docs** → suggest invoking `/wws-docs`
